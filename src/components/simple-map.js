...
const AnyReactComponent = () => {
  ...
  <div style={greatPlaceStyle}>
    <svg className="stroke-current stroke-2 text-black" height='40px' width='40px'  fill="#DC2626" version="1.1" x="0px" y="0px" viewBox="0 0 66.667 100" enableBackground="new 0 0 66.667 100">
